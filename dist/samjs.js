...
var rules$$1 = {};
rules$1.split('|').map(function (rule) {
  var r = reciterRule(rule), c= r.c;
  rules$$1[c] = rules$$1[c] || [];
  rules$$1[c].push(r);
});
var rules2$$1 = rules2$1.split('|').map(reciterRule);
...
function SamJs (options) {
  ...
  var convert = this.convert = function (text) {
    var input = TextToPhonemes(text);
    if (!input) {
      {
